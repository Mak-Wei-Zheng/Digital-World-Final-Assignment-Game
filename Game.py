...
player1 = input("What's player1's name: ")
while player1 == "":
    print("Hi, you didn't Enter your name.")
    player1 = input("What's player1's name: ")
    
player2 = input("What's player2's name: ")
while player2 == "":
    print("Hi, you didn't Enter your name.")
    player2 = input("What's player2's name: ")
...
Rules:
Each turn, players guess a number from 1 to 10,
...
#Choose your character
    ...
    while not character1_chosen:
        ...
        if character1_choice.lower() == "vampire":
            ...
            character1 = Char("tank",100,100,5,8,0,player1)
            character1.start()
            character1_chosen = True
    ...
    while not character2_chosen:
        ...
        if character2_choice.lower() == "vampire":
            ...
            character2 = Char("tank",100,100,5,8,0,player2)
            character2.start()
            character2_chosen = True
...
### dice roll to see who begins the game
    ...
    dice1 = input(player1 + " rolls [Y/N]:")
    while dice1.upper() == "N":
        dice1 = input(player1+ " please roll [Y/N]:")
    if dice1.upper() == "Y":
        print("You rolled a "+str(player1_roll))
    dice2 = input(player2 + " rolls [Y/N]:")
    while dice2.upper() == "N":
        dice2 = input(player2+ " please roll [Y/N]:")
    if dice2.upper() == "Y":
        print("You rolled a "+str(player2_roll))
    ...
    while character1.health>0 and character2.health>0:
        ...
        player2_spell = input(player1 + ", spell choice of heal/ ignite/ extinguish/lightning/ none [H/I/E/L/N]: ").upper()
        ...
        elif player1_spell == "N" or player1_spell == "E" or player1_spell == "H":
            character1.step(player1_spell)
        if player2_spell == "I" or player2_spell == "L":
            character2.step(player1_spell)
        elif player2_spell == "N" or player2_spell == "E" or player2_spell == "H":
